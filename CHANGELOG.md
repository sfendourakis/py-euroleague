...
### Fixed
- Fixed PyPI release (version bump that was missing in 0.2.0)
...
[0.2.0]: https://github.com/sfendourakis/py-euroleague/releases/tag/v0.2.0
[0.2.1]: https://github.com/sfendourakis/py-euroleague/releases/tag/v0.2.1
